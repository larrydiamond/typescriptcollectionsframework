...
describe("Test TreeMap functionality", function () {
    ...
    it("Test floorEntry", function () {
        ...
        expect(basicTypesMap1.floorEntry("AAAAA")).toEqual(new BasicMapEntry_1.BasicMapEntry("AAAAA", 0.99));
        ...
        expect(basicTypesMap1.floorEntry("Celery")).toEqual(new BasicMapEntry_1.BasicMapEntry("Catnip", 4.99));
