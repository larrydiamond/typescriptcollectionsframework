...
describe("Test TreeSet functionality", function () {
    ...
    it("Test Adding repeatedly", function () {
        var TreeSet1 = new TreeSet_1.TreeSet(alphabeticalSortPetStoreProduct);
        expect(TreeSet1.size()).toEqual(0);
        expect(TreeSet1.isEmpty()).toEqual(true);
        expect(TreeSet1.add(product1)).toEqual(false);
        expect(1).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product2)).toEqual(false);
        expect(2).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product3)).toEqual(false);
        expect(3).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product4)).toEqual(false);
        expect(4).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product4)).toEqual(true);
        expect(4).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product4)).toEqual(true);
        expect(4).toEqual(TreeSet1.size());
        ...
        expect(4).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product3)).toEqual(true);
        expect(4).toEqual(TreeSet1.size());
        expect(false).toEqual(TreeSet1.isEmpty());
        expect(TreeSet1.add(product4)).toEqual(true);
        expect(4).toEqual(TreeSet1.size());
